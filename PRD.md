...
This document serves as the source of truth for the Sutrini.in project.

```json
{
  "vision": "Sutrini.in digitizes India-based embroidery manufacturing with a multi-tenant, mobile-first platform that streamlines ordering, production, and delivery. It combines QR-driven factory workflows and real-time customer tracking to reduce lead times and boost order accuracy at scale.\n",
  "objectives": [
